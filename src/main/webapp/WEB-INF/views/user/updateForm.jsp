...
<legend class=c1>회원정보수정</legend>
	<form class=d1 action="/user/update" method="post">
		...
		비밀번호 <input type="password" name="userPw" class="pw" value="${user.userPw}" ><br>
		이름 <input type="text" name="userName" class="name" value="${user.userName} "><br>
		이메일 <input type="text" name="userEmail" class="email" value="${user.userEmail}"><br>
		<div class=btn-div>
