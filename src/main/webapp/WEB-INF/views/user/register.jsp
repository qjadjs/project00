      ...
      <div class="textForm">
         <div class="register-div">
            <input type="text" name="userId" class="id" id="userId"
               placeholder="아이디"autocomplete='off' onfocus="this.placeholder = '영어 대소문자, 숫자 포함 4-12'"  onblur="this.placeholder = '아이디'"> <input type="button"
         ...
         <div class="register-dpw">
            <input type="password" name="userPw" class="pw" id="password"
               placeholder="비밀번호"autocomplete='off' onfocus="this.placeholder = '영어 대소문자, 숫자 포함 4-12'"onblur="this.placeholder = '비밀번호'" >
         </div>
         <div class="register-dpwc">
            <input type="password" name="passwordConfrim" class="pw"
               id="passwordConfirm" placeholder="비밀번호  확인" autocomplete='off' onkeyup="passConfirm()">
